...
TSC_PRJG_PSUMS="tool for offline cryptos against blackouts and hyperinflation"
TSC_PRJG_PSUML="Tool for offline cryptos against blackouts and hyperinflation"
...
CFLAGS_GLIB=`pkg-config --cflags glib-2.0 pango cairo gdk-pixbuf`" -I /usr/include -I /usr/lib64 -I "$TSC_CDPA_INCL
CFLAGS_GTK=`pkg-config --cflags gtk-3.0 pango cairo gdk-pixbuf`"-I /usr/include -I /usr/lib64 -I "$TSC_CDPA_INCL
